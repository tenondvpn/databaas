"""
Django settings for dags project.
...
SIMPLE_JWT = {
    ...
    "ROTATE_REFRESH_TOKENS": False,                # 是否在刷新时生成新 token
    "BLACKLIST_AFTER_ROTATION": False,             # 刷新后是否将旧 token 列入黑名单
    "ALGORITHM": "HS256",
    "SIGNING_KEY": "你的密钥",  # 建议使用 SECRET_KEY
    "VERIFYING_KEY": "",
    "AUDIENCE": None,
    "ISSUER": None,
...
WSGI_APPLICATION = 'dags.wsgi.application'
